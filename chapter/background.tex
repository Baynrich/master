...
A loss function is then applied to the output of the linear layer, yielding a measure of the 'closeness' of the neural network's approximated output, and the desired output.
...
The process of optimizing the parameters of a neural network model is commonly referred to as 'Backpropagation'.
One common such algorithm is the Gradient Descent algorithm.

\subsubsection{Gradient Descent}

The Gradient Descent algorithm utilises the gradient of 

\subsubsection{Adding Stochasticity}
