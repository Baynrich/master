...
\textcolor{red}{\textbf{randomised weights}}

\textcolor{red}{\textbf{randomised bias term}}
...
a sample Neural Netowrk can be constructed. Furthermore, this Neural Netowrk can be used as a tool to explore the functionality of Neural Networks
...
Let us therefor consider a simple, two layer neural network.
